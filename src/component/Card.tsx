  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-20">
      <div className="text-center">
        ...
        <h3>
          Answer to common questions about our frontend challenges website
        </h3>
      </div>

      <div className="">
        <QuestionLists
          question="Can I use FrontendPro to prepare for a Frontend Developer interview?"
          answer="Sure"
          color="yellow"
        />
        <QuestionLists
        ...
        <QuestionLists
          ...
          answer="Beginner, Intermediate and Advanced"
          color="red"
        />
        <QuestionLists
          question="Can I use libraries or frameworks on this projects?"
          answer="You can explore with framework to speed your work"
          color="green"
        />
      </div>
    </div>
