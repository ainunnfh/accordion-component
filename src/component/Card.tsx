...
const Card = () => {
  return (
    <div className='bg-white rounded-lg shadow-md p-20'>
      ...
      <div className=''>
        <QuestionLists question='Can I use FrontendPro to prepare for a Frontend Developer interview?' answer='Sure' color='yellow' />
        ...
        <QuestionLists question='Can I use libraries or frameworks on this projects?' answer='You can explore with framework to speed your work' color='slate-300' />
      </div>
    </div>
  )
}
